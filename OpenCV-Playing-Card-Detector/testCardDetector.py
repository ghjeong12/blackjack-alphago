...
IMAGE_PATH = '../trumcard_images/1_Spade.jpg'
image = cv2.imread(IMAGE_PATH)

# Pre-process camera image (gray, blur, and threshold it)
pre_proc = Cards.preprocess_image(image)

cv2.imwrite('pre_proc.png',pre_proc)
...
if len(cnts_sort) != 0:
    ...
    #cv2.putText(image,"FPS: NA"+(10,26),font,0.7,(255,0,255),2,cv2.LINE_AA)
    #
